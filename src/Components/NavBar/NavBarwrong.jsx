    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ backgroundColor: 'white' ,borderBottom: '1px solid gray', height:'50px', boxShadow: 'none' }}>
        <Toolbar>
          ...
          <Typography variant="h6" component="div" sx={{ color:'black', fontSize: '18px', fontWeight: '28px'  }}>
            {props.PageName}
          </Typography>
          ...
          <Typography variant="h6" component="div" sx={{  color:'black', fontSize: '15px', fontWeight: '10px', marginLeft: '15px' }}>

            <a href={props.Tab1Link} style={{ textDecoration: 'none', color: 'inherit'}}>
             {props.Tab1}
            </a>
          </Typography>

          <Typography variant="h6" component="div" sx={{ color:'black', fontSize: '15px', fontWeight: '10px' , marginLeft: '15px' }}>
          <a href={props.Tab2Link} style={{ textDecoration: 'none', color: 'inherit' }}>
            {props.Tab2}
          </a>
          </Typography>
